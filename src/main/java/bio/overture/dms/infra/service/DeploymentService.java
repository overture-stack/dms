...
public class DeploymentService {
  ...
  public Future<String> deploy(
      @NonNull DockerContainer<?> dockerContainer, @NonNull DeployCallback callback) {
  ...
  public static DeploymentService createDefaultDeploymentService(
      @NonNull DockerService dockerService, int numFixedThreads) {
  ...
  public static DeploymentService createDeploymentService(
      @NonNull DockerService dockerService, @NonNull ExecutorService executorService) {
    return new DeploymentService(dockerService, executorService);
  }

  private String deployDockerContainer(
      DockerContainer<?> dockerContainer, DeployCallback callback) {
    dockerService.ping();
