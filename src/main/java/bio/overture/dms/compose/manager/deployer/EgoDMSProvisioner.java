...
//    provisionApplication(spec.getDmsUiAppCredential());
  ...
  public EgoPolicy provisionPolicy(@NonNull String policyName){
    val policyRequest = PolicyRequest.builder()
        .name(policyName)
        .build();
  ...
  public void provisionApplication(@NonNull AppCredential appCredential){
    val r = ApplicationRequest.builder()
        ...
        .type("ADMIN")
        .status("APPROVED")
        .description("DO NOT EDIT - Autogenerated by DMS - "+appCredential.getName()+" application credentials")
        .build();
