package bio.overture.dms.env.exception;
...
public class EnvProcessingException extends RuntimeException {
  ...
  public static void checkEnvProcessing(
      boolean expression, String formattedMessage, Object... args) {
    if (!expression) {
      throw buildEnvProcessingException(formattedMessage, args);
    }
  }

  public static EnvProcessingException buildEnvProcessingException(
