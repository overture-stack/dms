...
public class QuestionTest {
  ...
  public void urlQuestion_invalidFollowedByCorrect_success() {
    ...
    runRequiredQuestionTest(
        List.of(missingProtocol, invalidProtocol, correctProtocol, invalidProtocol), 2);
  }
  ...
  private void runRequiredQuestionTest(List<String> answers, int successfulAnswerIndex) {
    ...
    // Ask the question
    val actualUrl = questionFactory.newUrlSingleQuestion("Enter a url:", false, null).getAnswer();
  ...
  private void runOptionalQuestionTest(String answer, URL defaultUrl) {
    ...
    // Ask the question
    val actualUrl =
        questionFactory.newUrlSingleQuestion("Enter a url:", true, defaultUrl).getAnswer();
