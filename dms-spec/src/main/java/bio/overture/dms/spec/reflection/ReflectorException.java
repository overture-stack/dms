...
public class ReflectorException extends RuntimeException {
  ...
  public ReflectorException(Throwable cause, boolean enableSuppression,
  ...
  public static ReflectorException buildReflection(@NonNull String formattedMessage, Object ... args){
