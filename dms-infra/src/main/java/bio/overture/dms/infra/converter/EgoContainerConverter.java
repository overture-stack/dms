...
public class EgoContainerConverter implements Converter<EgoSpec, List<DockerContainer<?>>> {
   ...
   * Constants
   */
  private static final RandomGenerator RANDOM_GENERATOR = createRandomGenerator(EgoContainerConverter.class.getSimpleName());
  ...
  private static DockerContainer<PostgresServiceProperties> buildDbDockerContainer(@NonNull String networkName, @NonNull EgoSpec egoSpec){
  ...
  private static EgoApiServiceProperties buildApiServiceProperties(EgoSpec egoSpec, DockerContainer<PostgresServiceProperties> dbDockerContainer){
  ...
  private static ClientDatabaseProperties buildClientDatabaseProperties(@NonNull DockerContainer<PostgresServiceProperties> dbDockerContainer){
  ...
  private static DockerContainer<EgoApiServiceProperties> buildApiDockerContainer(String networkName, EgoApiServiceProperties apiServiceProperties){
