...
public class InvalidSpecException extends RuntimeException {
  ...
  public InvalidSpecException(Throwable cause, boolean enableSuppression,
  ...
  public static InvalidSpecException buildInvalidSpecException(@NonNull String formattedMessage, Object ... args){
